...
class FileBrowserFragmentUITest : BaseUITest() {
    ...
    fun whenAtRoot_checkLongPressOfInternalStorageUpdatesBackgroundAndAppbar() {
        ...
        onView(rvMatcher.atPosition(1))
                .check(matches(withBgColor(context.getColor(R.color.green200transparent))))
    ...
    fun whenAtInternalStorage_checkMultipleSelectionWorks() {
        ...
        onView(rvMatcher.atPosition(0)).check(matches(withBgColor(context.getColor(R.color.green200transparent))))
        onView(rvMatcher.atPosition(2)).check(matches(withBgColor(context.getColor(R.color.green200transparent))))
    }
    ...
    fun whenAtRootAndClickedOnItemIcon_multiSelectionModeIsToggled() {
        ...
        onView(rvMatcher.atPosition(1)).check(matches(withBgColor(context.getColor(R.color.green200transparent))))
        onView(rvMatcher.atPosition(3)).check(matches(withBgColor(context.getColor(R.color.green200transparent))))

        onView(rvMatcher.atPosition(3)).perform(click())
        onView(rvMatcher.atPosition(1)).perform(click())

        onView(rvMatcher.atPosition(1)).check(matches(not(withBgColor(context.getColor(R.color.green200transparent)))))
        onView(rvMatcher.atPosition(3)).check(matches(not(withBgColor(context.getColor(R.color.green200transparent)))))
    }
